...
#include "c:/vcast/mingw/include/float.h"
/* FUNCTION PROTOTYPES */
...
void VCAST_TI_9_10 ( struct order_type *vcast_param ) ;
void VCAST_TI_9_11 ( struct table_data_type *vcast_param ) ;
void VCAST_TI_9_12 ( enum boolean *vcast_param ) ;
void VCAST_TI_9_13 ( struct order_type vcast_param[4] ) ;
void VCAST_TI_9_14 ( enum soups *vcast_param ) ;
...
void VCAST_TI_9_4 ( struct order_type **vcast_param ) ;
void VCAST_TI_9_5 ( enum entrees *vcast_param ) ;
void VCAST_TI_9_6 ( unsigned *vcast_param ) ;
void VCAST_TI_9_7 ( enum salads *vcast_param ) ;
void VCAST_TI_9_8 ( enum beverages *vcast_param ) ;
void VCAST_TI_9_9 ( enum desserts *vcast_param ) ;
/*vcast_header_expansion_end*/
    ...
    case 0: /* for global objects */
      switch( VCAST_PARAM_INDEX ) {
        ...
        case 2: /* for global object WaitingListSize */
          VCAST_TI_9_6 ( &(WaitingListSize));
          break;
        case 3: /* for global object WaitingListIndex */
          VCAST_TI_9_6 ( &(WaitingListIndex));
          break;
        default:
...
{
  {
    switch ( vcast_get_param () ) { /* Choose field member */
      ...
      case 1: {
        VCAST_TI_9_12 ( &(vcast_param->Is_Occupied));
        break; /* end case 1*/
      } /* end case */
      ...
      case 5: {
        VCAST_TI_9_13 ( vcast_param->Order);
        break; /* end case 5*/
      } /* end case */
    ...
    if (((*vcast_param) == 0) && (vCAST_COMMAND != vCAST_ALLOCATE)){
      ...
      if ( (vCAST_COMMAND_IS_MIN_MAX == vCAST_true) &&( VCAST_FIND_INDEX() < 0 ) ) {
        ...
        if (vCAST_COMMAND == vCAST_ALLOCATE && vcast_proc_handles_command(1)) {
          int VCAST_TI_9_4_array_size = (int) vCAST_VALUE;
          if (VCAST_FIND_INDEX() == -1) {
            void **VCAST_TI_9_4_memory_ptr = (void**)vcast_param;
            *VCAST_TI_9_4_memory_ptr = (void*)VCAST_malloc(VCAST_TI_9_4_array_size*(sizeof(struct order_type )));
            memset((void*)*vcast_param, 0x0, VCAST_TI_9_4_array_size*(sizeof(struct order_type )));
            ;
          }
          ...
          VCAST_TI_9_4_index = vcast_get_param();
          VCAST_TI_9_10 ( &((*vcast_param)[VCAST_TI_9_4_index]));
        }
      }
    }
  }
    ...
    if ( vCAST_SIZE && (!VCAST_TI_9_13_more_data)) { /* get the size of the array */
      ...
      for (VCAST_TI_9_13_array_index=0; VCAST_TI_9_13_array_index< VCAST_TI_9_13_upper; VCAST_TI_9_13_array_index++){
        if ( (VCAST_TI_9_13_index >= VCAST_TI_9_13_first) && ( VCAST_TI_9_13_index <= VCAST_TI_9_13_last)){
          VCAST_TI_9_10 ( &(vcast_param[VCAST_TI_9_13_index]));
...
void VCAST_TI_RANGE_DATA_9 ( void ) {
  ...
  vectorcast_fprint_integer (vCAST_OUTPUT_FILE,(-2147483647 -1) );
  vectorcast_fprint_string (vCAST_OUTPUT_FILE,"\n" );
  vectorcast_fprint_integer (vCAST_OUTPUT_FILE,((-2147483647 -1) / 2) + (2147483647 / 2) );
  vectorcast_fprint_string (vCAST_OUTPUT_FILE,"\n" );
  vectorcast_fprint_integer (vCAST_OUTPUT_FILE,2147483647 );
  vectorcast_fprint_string (vCAST_OUTPUT_FILE,"\n" );
  /* Range Data for TI (scalar) VCAST_TI_8_1 */
  vectorcast_fprint_string (vCAST_OUTPUT_FILE, "NEW_SCALAR\n" );
  vectorcast_fprint_string (vCAST_OUTPUT_FILE,"900003\n" );
  vectorcast_fprint_integer (vCAST_OUTPUT_FILE,(-128) );
  vectorcast_fprint_string (vCAST_OUTPUT_FILE,"\n" );
  vectorcast_fprint_integer (vCAST_OUTPUT_FILE,((-128)/2) + (127/2) );
  vectorcast_fprint_string (vCAST_OUTPUT_FILE,"\n" );
  vectorcast_fprint_integer (vCAST_OUTPUT_FILE,127 );
  vectorcast_fprint_string (vCAST_OUTPUT_FILE,"\n" );
  ...
  vectorcast_fprint_string (vCAST_OUTPUT_FILE,"\n" );
  vectorcast_fprint_unsigned_integer (vCAST_OUTPUT_FILE,(0 / 2) + (0xffffffff / 2) );
  vectorcast_fprint_string (vCAST_OUTPUT_FILE,"\n" );
  vectorcast_fprint_unsigned_integer (vCAST_OUTPUT_FILE,0xffffffff );
  vectorcast_fprint_string (vCAST_OUTPUT_FILE,"\n" );
